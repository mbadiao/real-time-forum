...
// 	query := "SELECT * FROM Sessions WHERE cookie_value = ?"
// 	sessions, err := utils.ScanWithSessions(db, query, ActualCookie)
// 	if err != nil {
...
func RegisterHandler(w http.ResponseWriter, r *http.Request) {
	...
	for {
		...
		fmt.Println("a envoyer", userData)
